...
/**
 * Helper: Convert segments to text for validation
 */
 ...
 */
function performGuaranteedSplit(
  segments: readonly Segment[],
  cursor: CursorPosition
): {
  head: Segment[];
 ...
 * 
 * 🔒 GUARANTEED CORRECT SPLIT - Uses exhaustive state machine
 * 
 * This ensures:
