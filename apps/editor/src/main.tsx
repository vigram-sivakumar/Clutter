...
import './styles/sidepanel-title.css';
...
import './styles/sidepanel-section-subheader.css';
import './styles/sidepanel-section-header.css';
import './styles/sidepanel-section-layout.css';
import './styles/sidepanel-section-group-layout.css';
import './styles/empty-state.css';
import './styles/sidepanel-nav-item.css';
import './styles/sidepanel-footer.css';
import './styles/sidepanel-nav-list.css';
