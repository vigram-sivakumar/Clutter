...
export function PageTitle({
  ...
  // is never empty (toResourcePageModel excludes 'daily-note' from the
  // isAutoGeneratedName check that blanks a title), so this default
  // assumes 'note' rather than needing a type prop no caller would
  // otherwise use.
