...
import { folderTopBarMenu } from '@features/notes/mock/FolderTopBarMenu';

export interface FolderTopBarProps {
  breadcrumbs: Breadcrumb[];
}

export function FolderTopBar({ breadcrumbs }: FolderTopBarProps) {
