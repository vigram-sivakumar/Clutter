...
import { HashtagMentionMenu } from '@clutter/editor';
...
export const TagInput = ({ onAddTag, existingTags, placeholder = 'Add tag...', onCancel, initialValue = '' }: TagInputProps) => {
  ...
  // Calculate actual display count (matches HashtagMentionMenu logic)
  ...
  const handleKeyDown = useCallback((e: KeyboardEvent<HTMLInputElement>) => {
    if (e.key === 'Enter') {
      ...
      // Get the actual displayed items (matches HashtagMentionMenu logic)
